            ...
            <div className="card mb-3 mx-auto my-5 startup_form">
                <div className="row g-0">
                    <div className="col-md-5 col-sm-12">
                        <img src="https://www.pcg-services.com/wp-content/uploads/2016/08/startup-business-strategy-1.jpg" className="img-fluid rounded-start review_image" alt="creator-image" />
                    </div>
                    <div className="col-md-7 col-sm-12">
                        <div className="card-body">
                            <h5 className="card-title text-center">Creator Rating Form</h5>
                            <form className="my-4">
                                <label className="form-label text-muted mb-3">How much rating will you give:</label>
                                <div className="mb-3">
                                    <label className="form-label text-muted">To the creator’s overall idea and vision?</label>
                                ...
                                <div className="mb-3">
                                    <label className="form-label text-muted">To the creator’s approach and methods?</label>
                                ...
                                <div className="mb-3">
                                    <label className="form-label text-muted">To the creator’s website or portfolio?</label>
                                ...
                                <div className="mb-3">
                                    <label className="form-label text-muted">To the creator’s social media presence (e.g., Instagram)?</label>
